...
## 数据规模
- 数据行数: 566 行
- 字段列数: 28 列（v1.4.1 逻辑结构；新增字段 fdId 由发布平台生成）
...
- 不可回收投资 (v1.4.1 补齐，fdId 由发布平台生成)
  - 字段类型: DOUBLE
  - 元类型: METRIC
  - 计算类型: normal
  - 来源: ETL 聚合字段

- 投资起始日 (v1.4.1 补齐，fdId 由发布平台生成)
  - 字段类型: DATE
  - 元类型: DIM
  - 计算类型: normal
  - 来源: ETL 聚合字段
...
- 剩余回本月数 (v1.4.1 新增，fdId 由发布平台生成)
  - 字段类型: INT
  - 元类型: METRIC
  - 计算类型: normal
  - 来源: ETL 计算字段

- 回本状态 (v1.4.1 新增，fdId 由发布平台生成)
  - 字段类型: STRING
  - 元类型: DIM
  - 计算类型: normal
  - 来源: ETL 计算字段
...
- 数据快照日期 (v1.4.1 新增，fdId 由发布平台生成)
  - 字段类型: DATE
  - 元类型: DIM
  - 计算类型: normal
  - 来源: ETL 运行参数 as_of_date
